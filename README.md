...
```text
----------------------------------------------------
  ✨ WorshipPresenter Studio Server is running!
----------------------------------------------------
...
- **1-Click Style Presets**: *Midnight Celestial*, *Golden Glory*, *Deep Ocean Praise*, *Majestic Cinzel*, *Broadcast Lower-Third*, *Ruby Horizon*.
